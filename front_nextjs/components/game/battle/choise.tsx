...
export default function Choise({socket}) {
	...
	return (
		<div className="w-full h-full flex-col justify-start flex justify-center items-center">
			...
			<button onClick={Drop} className="w-[8rem] h-[3rem] border-2 border-black my-1">포기</button>
			<button onClick={Double} className="w-[8rem] h-[3rem] border-2 border-black my-1">따당</button>
		</div>
	);
}
